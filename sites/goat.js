...
module.exports = {
  ...
  async getter (url, proxy) {
    ...
    if (!price) price = '$' + context.default_store['product-templates'].slug_map[Object.keys(context.default_store['product-templates'].slug_map)[0]].new_lowest_price_cents / 100
